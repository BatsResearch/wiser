...
// and switched to BERT features
{
  ...
  "train_data_path": "output/generative/naive_bayes/train_data.p",         // If necessary, change to your own data path
  "validation_data_path": "output/generative/naive_bayes/dev_data.p",
  "test_data_path": "output/generative/naive_bayes/test_data.p",
