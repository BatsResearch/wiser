    ...
    def _read(self, file_path: str) -> Iterator[Instance]:
        ...
        if(os.path.isdir(file_path)):
            ...
            for filename in os.listdir(file_path):
                ...
                yield instanceGen(datapath, self.split_sentences, self.token_indexers)

        else:
            yield instanceGen(file_path, self.split_sentences, self.token_indexers)
            
        
def instanceGen(datapath, split_sentences, token_indexers):
